...
function avoidObstacles(niz) {
    var niz1 = niz.sort(function(a,b){return a-b ;});
    var i;    
    var brojac =0;
      ...
      for ( i =1 ; i< 1500; i++){
             ...
             for(var j=0;j<niz1.length;j++){
                  ...
                  if (niz[j] % i === 0 ){brojac=0; break;}else {brojac+=1;}
                  if(brojac ===niz1.length){console.log(i); return i;}
             }
      }
}